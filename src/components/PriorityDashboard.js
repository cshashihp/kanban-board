...
function PriorityDispBoard(props){
  ...
  for (let i=0; i< n ; i++){
    ...
    switch(tickets[i].priority){
        case 0 :  cardscol1.push(card);
                        break;
        case 4 :  cardscol2.push(card);
                        break;  
        case 3 :  cardscol3.push(card);
                        break; 
        case 2 :  cardscol4.push(card);
                        break;  
        case 1:   cardscol5.push(card);
                        break;                                                                     
        default:        break;                
    }
...
const col1 = {id: 12, title: "No Priority", cards:cardscol1};
const col2 = {id: 13, title: "Urgent", cards:cardscol2};
const col3 = {id: 14, title: "High", cards:cardscol3};
const col4 = {id: 15, title: "Medium", cards:cardscol4};
const col5 = {id: 16, title: "low", cards:cardscol5};
...
const board = {
  ...
  return (
    <div> 
        <h4>Grouping by Priority and Ordering by {props.sortopt} </h4>
        <Board>
                {board}
        </Board>
    </div>
...
export default PriorityDispBoard 